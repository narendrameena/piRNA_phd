...
FC <-"/mnt/home3/miska/nm667/scratch/inProgress/mice_PiRNA/analysis/claude_biomni_analysis/unique_pirna/unique16/final_classified.csv.gz"
...
fc<-fread(cmd=paste("zcat",FC)); uni<-unique(fc[grepl("^unique",klass) & timepoint==tp]$sequence)
