...
pd.DataFrame({"strain":order,"private_Mb":[round(v,2) for v in vals]}).to_csv(f"/mnt/home3/miska/nm667/scratch/inProgress/mice_PiRNA/figures/analysis_figures/10_cluster_pangenome_PAV/data/source_data/SourceData_private_by_strain.csv",index=False)
