...
# C57BL_6NJ reference clusters from the VERIFIED COMBINED run (chr-prefixed)
tp_beds = {
    "E16.5": f"{COMBINED_BEDS}/C57BL_6NJ_E16.5.bed",
    "P12.5": f"{COMBINED_BEDS}/C57BL_6NJ_P12.5.bed",
    "P20.5": f"{COMBINED_BEDS}/C57BL_6NJ_P20.5.bed",
}
...
# Source = combined_beds/ (reps pooled BEFORE PICB; xlsx verified chr1-19+X).
# Same chr-prefixed naming as the old 2-of-3 BEDs -> Steps 3-5 unchanged.
# ══════════════════════════════════════════════════════════════════════════════
