...
snakemake --printshellcmds --use-conda --conda-frontend conda -s workflow/Strain_Snakefile_black6_P12_5_P20_5 --latency-wait 100 --output-wait 100 --jobs 999 $1 --max-status-checks-per-second 500 --profile /mnt/home3/miska/nm667/scratch/inProgress/mice_PiRNA/config/
