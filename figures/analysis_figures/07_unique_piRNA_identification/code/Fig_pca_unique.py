...
FTITLE={"all_expressed":"All expressed piRNAs (top-500 variable)","unique":"Genuinely-unique piRNAs (Step 4)"}
...
fig.tight_layout()
for e in ("pdf","svg","png"): fig.savefig(f"{U}/Fig_pca_unique.{e}",bbox_inches="tight")
