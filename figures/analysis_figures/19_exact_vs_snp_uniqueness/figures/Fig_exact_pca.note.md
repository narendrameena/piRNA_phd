...
- **Shows:** per stage (E16.5/P12.5/P20.5), PCA of the exact-sequence genuinely-unique piRNA expression across the 48 libraries (log2 CPM by libsize_window), **plus a 4th panel pooling ALL timepoints** (14,514 exact-unique sequences × 144 libraries, markers by timepoint); points coloured classical vs wild-derived; wild outliers labelled (arrow-leadered to clear space), 12 classical strains annotated collectively.
