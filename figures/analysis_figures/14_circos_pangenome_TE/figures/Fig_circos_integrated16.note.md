# Fig_circos_integrated16 — circos pangenome view

**Shows:** integrated rings: TE expression + piRNA silencing + PICB cluster architecture, 16 strains.  Rings = the 16 strains (canonical thesis order); axis = GRCm39 genome in 2 Mb bins;
...
- **Code:** `code/Fig_circos_integrated16.py`
