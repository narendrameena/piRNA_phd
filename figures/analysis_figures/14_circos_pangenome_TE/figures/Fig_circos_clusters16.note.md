# Fig_circos_clusters16 — circos pangenome view

**Shows:** PICB cluster architecture per 2 Mb bin (+ strand / − strand / dual-strand), 16 strains.  Rings = the 16 strains (canonical thesis order); axis = GRCm39 genome in 2 Mb bins;
...
- **Code:** `code/Fig_circos_clusters16.py`
