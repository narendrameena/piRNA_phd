# Fig_circos_picb16 — circos pangenome view

**Shows:** PICB cluster FPM density across the genome, 16 strains.  Rings = the 16 strains (canonical thesis order); axis = GRCm39 genome in 2 Mb bins;
...
- **Code:** `code/Fig_circos_picb16.py`
