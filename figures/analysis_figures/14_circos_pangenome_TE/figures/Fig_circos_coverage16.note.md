# Fig_circos_coverage16 — circos pangenome view

**Shows:** genome-wide sRNA coverage rings, 16 strains.  Rings = the 16 strains (canonical thesis order); axis = GRCm39 genome in 2 Mb bins;
...
- **Code:** `code/Fig_circos_coverage16.py`
