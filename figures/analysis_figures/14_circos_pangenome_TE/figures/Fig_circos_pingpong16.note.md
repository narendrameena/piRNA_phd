# Fig_circos_pingpong16 — circos pangenome view

**Shows:** ping-pong signature (secondary piRNA biogenesis) rings, 16 strains.  Rings = the 16 strains (canonical thesis order); axis = GRCm39 genome in 2 Mb bins;
...
- **Code:** `code/Fig_circos_pingpong16.py`
