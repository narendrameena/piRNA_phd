# Fig_circos_combined16 — circos pangenome view

**Shows:** combined TE-expression (green, sense-out) + piRNA-on-TE (purple, antisense-in) rings, 16 strains.  Rings = the 16 strains (canonical thesis order); axis = GRCm39 genome in 2 Mb bins;
...
- **Code:** `code/Fig_circos_combined16.py`
