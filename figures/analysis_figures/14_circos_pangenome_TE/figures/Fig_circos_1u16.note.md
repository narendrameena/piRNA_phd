# Fig_circos_1u16 — circos pangenome view

**Shows:** 1U (5′-U primary-piRNA) bias rings across the genome, 16 strains.  Rings = the 16 strains (canonical thesis order); axis = GRCm39 genome in 2 Mb bins;
