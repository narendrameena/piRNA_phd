# Fig_circos_te_pirna16 — circos pangenome view

**Shows:** piRNA-on-TE (ANTISENSE-to-TE = silencing) vs TE expression (sense), per family, 16 strains.  Rings = the 16 strains (canonical thesis order); axis = GRCm39 genome in 2 Mb bins;
...
- **Code:** `code/Fig_circos_te_pirna16.py`
