# Fig_circos_te16 — circos pangenome view

**Shows:** TE expression (SENSE-to-TE sRNA) per family across the 16-strain pangenome, 2 Mb bins (outer ring).  Rings = the 16 strains (canonical thesis order); axis = GRCm39 genome in 2 Mb bins;
