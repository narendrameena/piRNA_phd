...
axD.text(0.5,-0.30,"A young active TE (ERVK/L1) inserts AFTER strains diverge → host mounts a piRNA response → a NEW, strain-specific,\nwell-expressed piRNA cluster absent from the reference (BioMNI-verified: Aravin 2007; Girard 2010; Gainetdinov 2015).\nCONFOUNDERS CHECKED: multimapping (corrected ✓) · total output (partial-controlled ✓) · lift-artifact (not divergence-\ndifferential ✓).  CAVEAT: effect is wild-vs-classical driven (within-classical n.s.; the 4 wild strains are non-independent).",transform=axD.transAxes,ha="center",va="top",fontsize=6.5,color="#444",style="italic")
