#!/usr/bin/env python3
"""THEME 17 — DECISIVE test: of TOTAL piRNA (24-32 nt reads, multimapper-weighted), what fraction maps inside PICB
...
ax.set_ylabel("% of TOTAL piRNA captured\n(24–32 nt reads, multimapper-weighted)",fontsize=10)
...
fig.text(0.5,-0.02,"of total piRNA (24–32 nt reads; samtools view -L + length filter), % mapping inside PICB clusters vs Trinity precursor EXON blocks · italic = PICB/Trinity ratio · sets overlap (not additive) · "
