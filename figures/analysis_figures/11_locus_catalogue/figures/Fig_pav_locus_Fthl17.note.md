# Fig_pav_locus_Fthl17 — Fthl17 family (X-linked germline multicopy)
...
- **Command:** `make_pav_locus.py X 8903132 8949671 "Fthl17 family (X-linked germline multicopy)" _ Fig_pav_locus_Fthl17`
