...
import os as _os; _T="13_divergence_loci" if OUT.startswith("Fig_divergence") else "11_locus_catalogue"; _SD=f"/mnt/home3/miska/nm667/scratch/inProgress/mice_PiRNA/figures/analysis_figures/{_T}/data/source_data"; _os.makedirs(_SD,exist_ok=True); FPM.to_csv(f"{_SD}/SourceData_{OUT}.csv")   # per-strain x tp FPM behind panel A; _SD from OUT prefix so themes 11 (Fig_pav_locus) + 13 (Fig_divergence) share one copy
