...
axD.set_ylabel("strain-specificity  log2FC (one-vs-rest, DESeq2)",fontsize=9.5); axD.spines[["top","right"]].set_visible(False)
...
axD.set_title("D  Beyond TE/mapping: heterochronic are also\nmore strongly strain-specific (higher one-vs-rest induction)",fontsize=9.5,fontweight="bold",loc="left")
