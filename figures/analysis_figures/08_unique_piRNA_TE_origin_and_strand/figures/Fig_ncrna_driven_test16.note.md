# Fig_ncrna_driven_test16

**Shows:** lncRNA-derived strain-private piRNAs, 16 strains  (ncRNA route (scaled))
...
- **Data table:** `data/source_data/SourceData_ncrna_driven_test16.csv`
- **Formats:** PDF+SVG+PNG.
