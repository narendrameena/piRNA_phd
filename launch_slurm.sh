...
snakemake --printshellcmds --use-conda --conda-frontend conda -s workflow/Strain_Snakefile --latency-wait 100 --output-wait 100 --jobs 15 $1 -T 5 --max-status-checks-per-second 500 --profile /mnt/home3/miska/nm667/scratch/inProgress/mice_PiRNA/config/
